      ...
      <div className="grid grid-cols-4">
        ...
        <div className="col-span-3 md:mt-4">
          <div className=" flex lg:justify-between md:px-8 justify-end">
            ...
            <div className="flex gap-1 justify-between">
              {accountProfile ? (
                ...
                <div>
                  {follow ? (
                    <button className="border border-blue-500 text-blue-500 text-xs px-5 rounded" style={{ height: "44px" }} onClick={HandleUnfollow}>
                      FOLLOWING
                    </button>
                  ) : (
                    <button className="bg-blue-600 hover:bg-blue-500 text-white text-xs px-5 rounded" style={{ height: "44px" }} onClick={HandleFollow}>
              ...
              <div>
                <button className="border border-gray-900 text-white bg-slate-500 py-2.5 text-xs font-medium rounded px-3 lg:px-5">MESSAGE</button>
              </div>
              {accountProfile ? (
          ...
          <div className="col-span-3 flex justify-around text-center m-5 md:px-8">
            ...
            <p className="text-xs text-gray-500">
              <span className={`${color} font-medium text-sm`}>{followers}</span>
              <br />
              Followers
            </p>
            <p className="text-xs text-gray-500">
              <span className={`${color} font-medium text-sm`}>{userData.following.length}</span>
              <br />
              Following
            </p>
          </div>
