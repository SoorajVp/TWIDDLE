  ...
  return (
    <div className="flex justify-center w-full mt-8">
      <div className="text-center">
        ...
        <Link to="search" >
          <button className="py-1 px-7 hover:bg-blue-600 hover:text-white text-blue-600 border border-blue-700 mt-3 rounded">Explore</button>
        </Link>
      </div>
    </div>
  )
