  ...
  return (
    <div className="">
      <div className="flex-1 justify-between flex flex-col h-screen pt-14 sm:pt-0 pb-8 sm:pb-0">
        ...
        <div className="border-t-2 border-gray-200 pt-1 pb-5 sm:mb-0">
          <div className="relative flex">
            ...
            <input
              ...
              className="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-2"
            />
            <div className="absolute right-0 items-center inset-y-0 ">
             
              <button
                type="button"
                className="inline-flex items-center justify-center rounded-lg px-1 py-2 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
